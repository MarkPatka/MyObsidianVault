...
**Прикладные сервисы (application services)**: не могут быть переиспользованы под разные задачи, так как ограничены определенным прикладным контекстом, но их можно встраивать в более высокоуровневые сервисы.  
